 ...
 * @author Difarifaldi
 */
public class Jaktim extends javax.swing.JFrame {

    /**
     * Creates new form Jaktim
     */
    public Jaktim() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cmbPilih.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(Pilih Rumah Sakit)", "RSUD Pasar Rebo", "RS Islam Pondok Kopi", "RS Harun Sisma", " ", " ", " " }));
    ...
    private void cekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekActionPerformed
        ...
        if(RS=="RS Harun Sisma"){
            PPQ.setText(lapor+="----------RS Harun Sisma----------"+"\n");

        }
        if(RS=="RSUD Pasar Rebo"){
            PPQ.setText(lapor+="----------RSUD Pasar Rebo----------"+"\n");

        }
        if(RS=="RS Islam Pondok Kopi"){
            PPQ.setText(lapor+="-----------RS Islam Pondok Kopi----------"+"\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jaktim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
