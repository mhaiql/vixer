 ...
 * @author Difarifaldi
 */
public class Jakbar extends javax.swing.JFrame {

    /**
     * Creates new form Jakbar
     */
    public Jakbar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cmbPilih.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(Pilih Rumah Sakit)", "RS Medika Permata", "RS Hermina Daan Mogot", "RS Royal Taruma", " " }));
    ...
    private void cekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekActionPerformed
        ...
        if(RS=="RS Medika Permata"){
            PPQ.setText(lapor+="----------RS Medika Permata----------"+"\n");

        }
        if(RS=="RS Hermina Daan Mogot"){
            PPQ.setText(lapor+="----------RS Hermina Daan Mogot----------"+"\n");

        }
        if(RS=="RS Royal Taruma"){
            PPQ.setText(lapor+="-----------RS Royal Taruma----------"+"\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jakbar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
