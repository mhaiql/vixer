 ...
 * @author Difarifaldi
 */
public class Depok extends javax.swing.JFrame {

    /**
     * Creates new form Depok
     */
    public Depok() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cmbPilih.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "(Pilih Rumah Sakit)", "RS Hermina", "RS HGA", "RS Naura Medika", " " }));
    ...
    private void cekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cekActionPerformed
        ...
        if(RS=="RS Hermina"){
            PPQ.setText(lapor+="----------RS Hermina----------"+"\n");

        }
        if(RS=="RS Naura Medika"){
            PPQ.setText(lapor+="-----------RS Naura Medika----------"+"\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Depok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
